...
% chaine 2 : Mapping binaire `a moyenne nulle, filtre de mise en forme de réponse
% impulsionnelle rectangulaire de hauteur 1 et de durée Ts, filtre de réception
% de réponse impulsionnelle rectangulaire de hauteur 1 et de durée Ts / 2
...
for indice_bruit=1:length(tab_Eb_N0_dB)
    ...
    while(nb_erreurs<1000)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        TES=TES+sum(symboles_recus ~= symboles)/N;        % A COMPLETER 
        
        %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %DEMAPPING
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        bits_recus=(symboles_recus==-1)*0+ (symboles_recus == 1)*1;     % A COMPLETER 
...
TEB_THEO=qfunc(sqrt(2*tab_Eb_N0));   % A COMPLETER
