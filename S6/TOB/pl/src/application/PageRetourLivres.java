...
public class PageRetourLivres extends JFrame {
    public PageRetourLivres(Catalogue catalogue, Utilisateurs utilisateurs, Livre livre) {
        setSize(BibliothequeAppSwing.dimmension[0]/2,BibliothequeAppSwing.dimmension[1]/2);

        Container retours = this.getContentPane(); 
        retours.setLayout(new BorderLayout());
    ...
    retours.add(panelInfo, BorderLayout.CENTER);
