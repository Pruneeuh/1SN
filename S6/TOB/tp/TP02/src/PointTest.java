...
public class PointTest {
	...
	public void testInitialisationMieux() {
		...
		assertEquals(4.0, p2.getX(), EPSILON); //ici
		assertEquals(-2.0, p2.getY(), EPSILON); //ici
	}
	...
	public void testCouleur(){
		assertTrue(Color.green==p1.getCouleur());
		assertTrue(Color.green==p2.getCouleur());
	}
	@Test
	public void testerSetCouleur(){
		p1.setCouleur(Color.red); 
		assertTrue(Color.red == p1.getCouleur());
	}
