 ...
 */
public class Point { //pareil que si on met final devant afficher 
	...
	/** Afficher le point. */
	public void afficher() { // si le met en mode final pas possible de le réecrire dans la classe PointNomme
