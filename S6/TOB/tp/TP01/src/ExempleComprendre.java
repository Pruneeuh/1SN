...
public class ExempleComprendre {
	...
	public static void main(String[] args) {
		...
		p1.setY(10);
		afficher("p1", p1);
										// Dessiner l'état de la mémoire p1 = (0,10) ; p2 = (0,0)
		// Prendre une nouvelle poignée sur p1
		System.out.println("> Point p3 = p1;");
		Point p3 = p1;
		afficher("p3", p3);		// Qu'est ce qui est affiché ?  p3 = (0,10)
		afficher("p1", p1);		// Qu'est ce qui est affiché ?	p1 = (0,10)

		// Déplacer p3
		System.out.println("> p3.translater(100, 100);");
		p3.translater(100, 100);
		afficher("p3", p3);		// Qu'est ce qui est affiché ?		p3 = (100,110)

		// Afficher p1
		afficher("p1", p1);		// Qu'est ce qui est affiché ?		p1 = (100,110) 
		...
		// p1, p2 et p3 sont-ils des points différents ? oui 
		System.out.println("> p1.translater(-123, -321);");
		p1.translater(-123, -321);
		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1 = (0,0)
		afficher("p2", p2);		// Qu'est ce qui est affiché ?	p2 = (0,0)
		afficher("p3", p3);		// Qu'est ce qui est affiché ? p3 = (0,0)

		d  = new Point(5, 5).distance(new Point(8, 1));   // d = 5 
		System.out.println("d = " + d);

							// Combien y a-t-il de points accessibles ? 3 
	}
}
