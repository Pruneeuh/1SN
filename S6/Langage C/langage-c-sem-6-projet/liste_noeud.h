#include "graphe.h"
#include <stdbool.h>
//Penser  à mettre paramètre comme CONS quand utile

// TODO : type liste_noeud_t
struct liste_noeud_t; 

// TODO : typedef
typedef struct liste_noeud_t liste_noeud;
 ...
 */
bool est_vide_liste(const liste_noeud liste);
 ...
 */
int distance_noeud_liste(const liste_noeud liste, noeud_id_t noeud);
 ...
 */
noeud_id_t precedent_noeud_liste(const liste_noeud liste, noeud_id_t noeud);
 ...
 */
noeud_id_t min_noeud_liste(const liste_noeud liste);
...
void inserer_noeud_liste(liste_noeud liste, noeud_id_t noeud, noeud_id_t precedent, int distance);
 ...
 */
void changer_noeud_liste(liste_noeud liste, noeud_id_t noeud, noeud_id_t precedent, int distance);
 ...
 */
liste_noeud supprimer_noeud_liste(liste_noeud liste, noeud_id_t noeud); 
