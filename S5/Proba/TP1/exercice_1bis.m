...
I_decorrelee = decorrelation_colonnes(I); % FONCTION A COMPLETER
...
[Vd,Vg] = vectorisation_par_colonne(I_decorrelee); % FONCTION COMPLETEE DANS EXERCICE_1
...
[r,a,b] = parametres_correlation(Vd,Vg); % FONCTION COMPLETEE DANS EXERCICE_1
