...
function [tirages_angles,tirages_G] = tirages_aleatoires_uniformes(n_tirages,taille)
    ...
    % Tirages aleatoires de points pour se trouver sur la droite (sur [-20,20] taille=20)
    tirages_G = rand(2,n_tirages)*taille*2-taille; % on tire des points (les coordonées de G)
