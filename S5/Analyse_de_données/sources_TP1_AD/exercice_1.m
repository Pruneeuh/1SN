...
subplot(7,3,11);
axis off
title(['r_{\color{red}R\color{green}V\color{black}} = ' num2str(correlation(1,2),'%.2f')],'FontSize',20);

% Affichage des correlations :
subplot(7,3,14);
axis off
title(['r_{\color{red}R\color{blue}B\color{black}} = ' num2str(correlation(1,3),'%.2f')],'FontSize',20);

% Affichage des correlations :
subplot(7,3,17);
axis off
title(['r_{\color{green}V\color{blue}B\color{black}} = ' num2str(correlation(2,3),'%.2f')],'FontSize',20);
