...
with LCA_Exceptions;         use LCA_Exceptions;
with Ada.Unchecked_Deallocation;

package body LCA is

   procedure Free is	new Ada.Unchecked_Deallocation (T_Cellule, T_LCA);
   ...
   function Cle_Actuelle(Sda : in T_LCA) return T_Cle is 
   begin 
      return Sda.all.Cle; 
   end Cle_Actuelle;
   ...
   procedure Concatener(Sda1 : in out T_LCA ; Sda2 : in T_LCA) is -- SDA1 forcément non nul 
      Parcours : T_LCA; 
   begin 
      Parcours := Sda1; 
